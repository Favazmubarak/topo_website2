        ...
        <div className="flex flex-col gap-6 sm:gap-8 md:gap-10 lg:gap-13 items-start w-full">
          <div className="inline-block mx-auto sm:mx-0 flex flex-col gap-2 sm:gap-3 md:gap-4">
            ...
            <div className="w-fit" data-aos="fade-right" data-aos-delay="200">
              <h1 className="font-highrise font-black text-transparent bg-white/20 backdrop-blur-sm rounded-full scale-y-120 origin-left animate-pulse uppercase leading-[0.9] text-[44px] sm:text-[56px] md:text-[70px] lg:text-[90px] xl:text-[100px] whitespace-nowrap">
            ...
            <div className="flex justify-end w-full mt-3 sm:mt-5 md:mt-6 lg:mt-7 xl:mt-8" data-aos="fade-left" data-aos-delay="400">
              <h2 className="font-highrise font-black text-transparent bg-white/20 backdrop-blur-sm rounded-full scale-y-120 origin-right animate-pulse uppercase leading-[0.9] text-[44px] sm:text-[56px] md:text-[70px] lg:text-[90px] xl:text-[100px] whitespace-nowrap text-right">
                MODERN LIVING
              </h2>
            </div>
          </div>
