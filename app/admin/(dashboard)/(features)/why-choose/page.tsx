...
const WhyChooseAdminPage = () => {
  const { images, fetchImage, loading: fetchLoading } = useImage("why-choose");
...
export default WhyChooseAdminPage;
