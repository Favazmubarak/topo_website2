...
export default function Navbar() {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 w-full z-50 flex items-center justify-between px-4 sm:px-6 md:px-12 lg:px-20 py-10 transition-all duration-300 bg-transparent ${isScrolled ? "py-7" : ""
        }`}
    >
      {/* Logo */}
