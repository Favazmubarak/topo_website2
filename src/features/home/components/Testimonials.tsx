    ...
    <section className="w-full bg-[#FBFBFB] md:py-24 sm:py-16 py-12 overflow-hidden border-y border-gray-50">
      <div className="px-6 md:px-12 lg:px-20">
        <div className="max-w-[1500px] mx-auto">
          ...
          {/* Section Header */}
          <div className="flex flex-col items-center text-center sm:mb-16 mb-8" data-aos="fade-up">
            ...
            <div className="w-12 h-[1px] bg-gray-200 sm:mt-8 mt-4" />
          </div>
          ...
          {loading ? (
            ...
            <div className="relative w-full">
              <div className="flex w-max animate-marquee hover:[animation-play-state:paused] sm:py-8 py-4">
                {scrollItems.map((testimonial, index) => (
                  <div
                    key={`${testimonial._id}-${index}`}
                    className="bg-white rounded-[32px] p-5 sm:p-8 flex flex-col h-[220px] sm:h-[260px] w-[340px] sm:w-[600px] mx-3 sm:mx-6 shrink-0 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.05)] border border-gray-100 transition-all duration-700 hover:shadow-[0_20px_50px_-20px_rgba(0,102,178,0.15)] hover:-translate-y-3"
                  >
                    {/* Golden Stars Rating */}
                    ...
                    <p className="font-poppins font-normal text-[#2A2A2A] text-[14px] md:text-[15px] leading-[1.4] md:leading-[1.5] mb-3 flex-grow italic overflow-y-auto no-scrollbar">
                      "{testimonial.review}"
                    </p>
